...
def get_neighbors(word):
    ...
    list_of_chars = list(word) #list() also used to split a string in to list of character (list() used to copy List and also to split a string - you cna use split() to create List from a string but u need separator (see split function deatil)
