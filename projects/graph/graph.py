...
class Graph:
    ...
    def add_vertex(self, vertex_id):
        ...
        """
        self.vertices[vertex_id] = set() #adding node or vertex with out any conection set() represent no connection(empty set data {})
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        while neighbors_to_visit.size() > 0:
            ...
            current_path = neighbors_to_visit.dequeue() #[A]
